...
public class TestAutomatonSpecification extends TestCase {
   ...
   /**
    ...
    /**
     * Test metody isInfinite, uwzględniający przejścia Epsilon.
     */
    public final void testIsInfiniteWithEpsilon() {
        AutomatonSpecification spec = new NaiveAutomatonSpecification();
        ...
        spec.addTransition(q2a, q1a, new EpsilonTransitionLabel());

        spec.markAsInitial(q0a);
        spec.markAsFinal(q2a);

        assertTrue(spec.isInfinite());
    }
